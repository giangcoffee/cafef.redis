...
{
    this.host = 'http://solieu5.cafef.vn';
    ...
    {
        this.CreateCssLink( 'http://solieu.cafef.vn/www/cafef/css/cafef.css');
    
        document.getElementById('CafeF_BaiVietHay').innerHTML = '<table width="350" border="0" cellspacing="0" cellpadding="0"><tr><td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="4" height="28"><img src="http://solieu.cafef.vn/www/cafef/images/BaiVietHay/img_gocleft.gif" width="4" height="28"/></td><td background="http://solieu.cafef.vn/www/cafef/images/BaiVietHay/img_back.gif" class="title"><img src="http://solieu.cafef.vn/www/cafef/images/BaiVietHay/img_arrow.gif" width="8" height="4" style="margin: 0px 6px 0px 5px" align="absmiddle"/><a class="title" title="Ý kiến chuyên gia" style="text-decoration:none;" href="/y-kien-chuyen-gia.chn">Ý KIẾN CHUYÊN GIA</a></td><td width="4"><img src="http://solieu.cafef.vn/www/cafef/images/BaiVietHay/img_gocright.gif" width="4" height="28"/></td></tr></table></td></tr><tr><td bgcolor="#FFFFFF" valign="top" id="CafeF_BaiVietHay_Content"></td></tr><tr><td bgcolor="#FFFFFF" style="text-align: right;padding-right: 10px; padding-top: 5px;"><a class="title" style="font-size: 11px; font-weight: normal;" title="Ý kiến chuyên gia" style="text-decoration:none;" href="/y-kien-chuyen-gia.chn">Xem tiếp</a></td></tr><tr><td><img src="http://solieu.cafef.vn/www/cafef/images/BaiVietHay/img_day.gif" width="350" height="6"/></td></tr></table></td></tr></table>';;
    }
    ...
    this.OnLoaded = function(data, methodName)
    {
        ...
        {
            output += '<tr><td><img src="http://solieu.cafef.vn/www/cafef/images/BaiVietHay/img_dot1.gif" width="5" height="5" style="margin: 0px 6px 0px 10px" align="absmiddle"/></td><td style="background-image: url(http://solieu.cafef.vn/www/cafef/images/BaiVietHay/img_dot.gif); background-position: bottom; background-repeat: repeat-x; padding-top: 5px; padding-bottom: 5px;"><a class="content" title="' + json.FavoriteNewsItems[i].Title + '" href="http://cafef.vn' + json.FavoriteNewsItems[i].Link + '">' + json.FavoriteNewsItems[i].Title + '</a>';
            if (json.FavoriteNewsItems[i].AuthorID != '')
            {
                output += '<br><span class="content1">Tác giả:</span> <a href="/blog-chuyen-ve-tai-chinh-chung-khoan/trang-0-' + json.FavoriteNewsItems[i].AuthorID + '.chn"<span class="tentacgia">' + json.FavoriteNewsItems[i].Author + '</span></a>';
            }
