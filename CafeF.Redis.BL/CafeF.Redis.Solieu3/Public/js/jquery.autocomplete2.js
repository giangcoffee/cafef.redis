...
$.Autocompleter = function(input, options) {
	...
	function selectCurrent() {
		...
		//document.location = "http://cafef.channelvn.net/DisplayContent.aspx?TabRef=CompInfo&m=profile&symbol=" + selected.data.c;
		document.location = "http://cafef.channelvn.net/Thi-truong-niem-yet/Thong-tin-cong-ty/" + selected.data.c+".chn";
		//window.open("http://cafef.channelvn.net/DisplayContent.aspx?TabRef=CompInfo&m=profile&symbol=" + selected.data.c);
		return true;
	}
	...
	*/
    ...
    {               
       //var url="http://cafef.channelvn.net/Thi-truong-niem-yet/Thong-tin-cong-ty/"+__Stock+".chn";
       var url="http://cafef.channelvn.net/cafef-tools/chungkhoan24h/Companyinfo.aspx?symbol="+__Stock;
