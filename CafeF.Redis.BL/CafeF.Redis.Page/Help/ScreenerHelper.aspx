<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/SoLieu.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div style="width:900px;padding-left:30px" >
        <div style="padding-top: 10px;" class="cf_MBTop"></div>
        <div style="text-align:center;color:#C60000;font-size:20px;font-weight:bold;padding-bottom:10px">HƯỚNG DẪN SỬ DỤNG BỘ CÔNG CỤ DỮ LIỆU CỦA CAFEF</div>
        <div style="text-align:left;padding-left:20px;padding-bottom:10px">
        <h3>
            <ol style="line-height:20px">
                <li><a href="#1">Tại sao tôi cần bộ Công cụ dữ liệu của CafeF?</a></li>
                <li><a href="#2">Bộ Công cụ dữ liệu của CafeF có đặc điểm gì nổi bật?</a></li>
                <li><a href="#3">Bộ Công cụ dữ liệu của CafeF có những tính năng gì?</a></li>
                <li><a href="#4">Tôi tìm bộ Công cụ dữ liệu ở đâu?</a></li>
                <li><a href="#5">Tôi sử dụng bộ lọc cổ phiếu để làm gì?</a></li>
                <li><a href="#6">Bộ lọc cổ phiếu bao gồm những tiêu chí nào?</a></li>
                <li><a href="#7">Tôi sử dụng bộ lọc cổ phiếu như thế nào?</a></li>
                <li><a href="#8">Tôi muốn sử dụng thêm các tiêu chí khác?</a></li>
                <li><a href="#9">Nhiều chỉ tiêu quá, tôi muốn bỏ bớt đi?</a></li>
                <li><a href="#10">Tôi chẳng hiểu những tiêu chí này có ý nghĩa gì cả!</a></li>
                <li><a href="#11">Tôi có thể lưu lại bộ lọc mình đã dùng và gửi cho bạn bè được chứ?</a></li>
                <li><a href="#12">Tôi dùng bộ Thống kê biến động giá cổ phiếu để làm gì?</a></li>
                <li><a href="#13">Tôi sử dụng bộ Thống kê biến động giá cổ phiếu như thế nào?</a></li>
                <li><a href="#14">CafeF có những dữ liệu gì trong phần Tra cứu dữ liệu lịch sử?</a></li>
                <li><a href="#15">Tôi muốn tra cứu dữ liệu lịch sử của mã chứng khoán khác?</a></li>
                <li><a href="#16">Tôi muốn thay đổi thời gian tra cứu dữ liệu lịch sử?</a></li>
                <li><a href="#17">Tôi muốn biết cổ đông lớn/cổ đông nội bộ đó đã thực hiện những giao dịch nào?</a></li>
                <li><a href="#18">CafeF có những dữ liệu gì đối với một cổ phiếu?</a></li>
                <li><a href="#19">Tôi muốn tải xuống Báo cáo tài chính và Báo cáo khác?</a></li>
                <li><a href="#20">Tôi muốn biết Ban lãnh đạo của Công ty mình đang đầu tư là những ai? Công ty ấy có những cổ đông lớn nào?</a></li>
                <li><a href="#21">Công ty tôi đang đầu tư hiện có những Công ty con/Công ty liên kết nào?</a></li>
                <li><a href="#22">CafeF có bộ lọc tin tức doanh nghiệp theo từng chủ đề không?</a></li>
            </ol>
        </h3>
        </div>
        <div style="line-height:20px; border:1px solid #DADADA;padding:5px 5px 10px 5px;text-align:justify;width:900px;color:#343434;font-size:14px;font-family:Arial,Helvetica,sans-serif">
