...
namespace CafeF.Redis.Page.Compression
{
    ...
    public class ScriptHandlerOther : IHttpHandler
    {
        ...
        private static string _cacheKey = "ScriptHandlerOther1.v";

        private static readonly List<string> _files = new List<string>();

        static ScriptHandlerOther()
        {
            ...
            {
                Hashtable settings = ConfigurationManager.GetSection("ScriptSettingsOther") as Hashtable;
                if (settings != null)
                {
