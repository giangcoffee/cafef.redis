...
namespace CafeF.Redis.Page.Compression
{
    ...
    public class HeaderScriptHandler : IHttpHandler
    {
        ...
        private static string _cacheKey = "HeaderHandlerScripts1.v";

        private static readonly List<string> _files = new List<string>();

        static HeaderScriptHandler()
        {
            ...
            {
                Hashtable settings = ConfigurationManager.GetSection("HeaderScriptSettings") as Hashtable;
                if (settings != null)
                {
