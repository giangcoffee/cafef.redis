<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TMBLChart.ascx.cs" Inherits="CafeF.Redis.Page.UserControl.DuLieuViMo.TMBLChart" %>
...
<a name="giatrithuc"></a>
        <table>
            <tr>
                <td colspan="7" valign="top">
                    <strong>GIÁ TRỊ TỔNG MỨC BÁN LẺ</strong></td>
            ...
            <tr>
                <td colspan="2" valign="top">
                    Chọn chỉ tiêu</td>
                <td colspan="5">
                    <asp:CheckBoxList ID="chkChitieu" runat="server" Height="110px">
                        <asp:ListItem Selected="True" Value="120000"> Tổng mức b&#225;n lẻ</asp:ListItem>
                        <asp:ListItem Selected="True" Value="121000"> Thương nghiệp</asp:ListItem>
                        <asp:ListItem Selected="True" Value="122000"> Kh&#225;ch sạn nh&#224; h&#224;ng</asp:ListItem>
                        <asp:ListItem Selected="True" Value="123000"> Du lịch</asp:ListItem>
                        <asp:ListItem Selected="True" Value="124000"> Dịch vụ</asp:ListItem>
                    </asp:CheckBoxList></td>
            ...
            <tr id="trThangGT">
                ...
                <td>
                    ...
                    <input style="width:90px;" id="btnZoom" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=tmbl');"
        ...
        <td>
            ...
            <input style="width:90px" id="Button2" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=tmblquy');" />
        </td>
    </tr>
    <tr id="trNamGT" style="display:none">
                ...
                <td>
                    ...
                    <input id="Button4" style="width:90px" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=tmblnam');" />
                </td>
            </tr>
        </table>
        <br />
...
<asp:Literal ID="ltrChartGT3" runat="server"></asp:Literal>
        <br />
            ...
            <table>
                <tr>
                    <td colspan="7" valign="top">
                        <strong>TĂNG TRƯỞNG TỔNG MỨC BÁN LẺ (SO VỚI KỲ LIỀN TRƯỚC)</strong></td>
                    <td colspan="1" style="height:20px;">
                    </td>
                </tr>
                <tr>
                    <td colspan="2" valign="top">
                        Chọn chỉ tiêu</td>
                    <td colspan="5">
                        <asp:CheckBoxList ID="chkChitieuMoM" runat="server" Height="110px">
                            <asp:ListItem Selected="True" Value="120000"> Tổng mức b&#225;n lẻ</asp:ListItem>
                            <asp:ListItem Selected="True" Value="121000"> Thương nghiệp</asp:ListItem>
                            <asp:ListItem Selected="True" Value="122000"> Kh&#225;ch sạn nh&#224; h&#224;ng</asp:ListItem>
                            <asp:ListItem Selected="True" Value="123000"> Du lịch</asp:ListItem>
                ...
                <tr id="trThangTT">
                    ...
                    <td>
                        ...
                        <input style="width:90px;" id="Button1" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=tmblmom');"
        ...
        <td>
            ...
            <input style="width:90px" id="Button6" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=tmblmomquy');" />
        </td>
    </tr>
    <tr id="trNamTT" style="display:none">
                ...
                <td>
                    ...
                    <input id="Button8" style="width:90px" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=tmblmomnam');" />
                </td>
            </tr>
            </table>
            <br />
    ...
    <asp:Literal ID="ltrChartMoMTT3" runat="server"></asp:Literal>
            ...
            <table>
                <tr>
                    <td colspan="7" valign="top">
                        <strong>TĂNG TRƯỞNG TỔNG MỨC BÁN LẺ (SO VỚI CÙNG KỲ NĂM TRƯỚC)</strong></td>
                    <td colspan="1" style="height:20px;">
                    </td>
                </tr>
                <tr>
                    <td colspan="2" valign="top">
                        Chọn chỉ tiêu</td>
                    <td colspan="5">
                        <asp:CheckBoxList ID="chkChitieuMoMSoVoi" runat="server" Height="110px">
                            <asp:ListItem Selected="True" Value="120000"> Tổng mức b&#225;n lẻ</asp:ListItem>
                            <asp:ListItem Selected="True" Value="121000"> Thương nghiệp</asp:ListItem>
                            <asp:ListItem Selected="True" Value="122000"> Kh&#225;ch sạn nh&#224; h&#224;ng</asp:ListItem>
                            <asp:ListItem Selected="True" Value="123000"> Du lịch</asp:ListItem>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="Button3" style="width:90px" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=tmblmomsovoi');"
                            type="button" value="Phóng to" /></td>
                    <td>
                    </td>
                </tr>
