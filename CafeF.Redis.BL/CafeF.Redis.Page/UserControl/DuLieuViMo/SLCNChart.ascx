<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SLCNChart.ascx.cs" Inherits="CafeF.Redis.Page.UserControl.DuLieuViMo.SLCNChart" %>
...
<table>
    <tr>
        <td colspan="7" valign="top">
            <strong>GIÁ TRỊ SẢN LƯỢNG CÔNG NGHIỆP</strong></td>
    ...
    <tr>
        ...
        <td colspan="5">
            <asp:CheckBoxList ID="chkChitieu" runat="server" Height="90px">
                <asp:ListItem Selected="True" Value="110000"> Gi&#225; trị sản lượng c&#244;ng nghiệp</asp:ListItem>
                <asp:ListItem Selected="True" Value="111000"> Doanh nghiệp nh&#224; nước</asp:ListItem>
                <asp:ListItem Selected="True" Value="112000"> Doanh nghiệp ngo&#224;i quốc doanh</asp:ListItem>
                <asp:ListItem Selected="True" Value="113000"> Doanh nghiệp vốn đầu tư nước ngo&#224;i</asp:ListItem>
            </asp:CheckBoxList></td>
    ...
    <tr id="trThangGT">
        ...
        <td>
            ...
            <input style="width:90px" id="btnZoom" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=gtslcn');" />
        </td>
        <td>
        </td>
    </tr>
    <tr id="trQuyGT" style="display:none">
        ...
        <td>
            ...
            <input style="width:90px" id="Button2" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=gtslcnquy');" />
        </td>
    </tr>
    <tr id="trNamGT" style="display:none">
                ...
                <td>
                    ...
                    <input id="Button4" style="width:90px" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=gtslcnnam');" />
                </td>
            </tr>
</table>
<br />
...
<br />
    ...
    <table>
        <tr>
            <td colspan="7" valign="top">
                <strong>TĂNG TRƯỞNG GIÁ TRỊ SẢN LƯỢNG CÔNG NGHIỆP (SO VỚI KỲ LIỀN TRƯỚC)</strong></td>
            <td colspan="1" style="height:20px;">
            </td>
        </tr>
        <tr>
            <td colspan="2" valign="top">
                Chọn chỉ tiêu</td>
            <td colspan="5">
                <asp:CheckBoxList ID="chkChitieuMoM" runat="server" Height="90px">
                    <asp:ListItem Selected="True" Value="110000"> Gi&#225; trị sản lượng c&#244;ng nghiệp</asp:ListItem>
                    <asp:ListItem Selected="True" Value="111000"> Doanh nghiệp nh&#224; nước</asp:ListItem>
                    <asp:ListItem Selected="True" Value="112000"> Doanh nghiệp ngo&#224;i quốc doanh</asp:ListItem>
                    <asp:ListItem Selected="True" Value="113000"> Doanh nghiệp vốn đầu tư nước ngo&#224;i</asp:ListItem>
        ...
        <tr id="trThangTT">
            ...
            <td>
                ...
                <input style="width:90px" id="Button1" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=gtslcnmom');" />
            </td>
            <td>
            </td>
        </tr>
        ...
        <td>
            ...
            <input style="width:90px" id="Button6" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=gtslcnmomquy');" />
        </td>
    </tr>
    <tr id="trNamTT" style="display:none">
                ...
                <td>
                    ...
                    <input id="Button8" style="width:90px" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=gtslcnmomnam');" />
                </td>
            </tr>
    </table>
    <br />
    ...
    <table>
        <tr>
            <td colspan="7" valign="top">
                <strong>TĂNG TRƯỞNG GIÁ TRỊ SẢN LƯỢNG CÔNG NGHIỆP (SO VỚI CÙNG KỲ NĂM TRƯỚC)</strong></td>
            <td colspan="1" style="height:20px;">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input style="width:90px" id="Button3" type="button" value="Phóng to" onclick="openw('/UserControl/DuLieuViMo/Popup.aspx?type=gtslcnmom');" />
            </td>
            <td>
            </td>
        </tr>
