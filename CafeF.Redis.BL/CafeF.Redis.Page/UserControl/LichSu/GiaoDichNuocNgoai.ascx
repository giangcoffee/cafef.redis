<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GiaoDichNuocNgoai.ascx.cs"
    Inherits="CafeF.Redis.Page.UserControl.LichSu.GiaoDichNuocNgoai" %>
...
<%@ Register TagPrefix="cc1" Namespace="CafeF.Redis.Page" Assembly="CafeF.Redis.Page" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="SearchDataHistory_SearchForm">
            <tr>
                ...
                <td align="right">
                    <img align="absmiddle" src="http://cafef3.vcmedia.vn/images/new.gif" alt="" /><a href="/TraCuuLichSu2/TraCuu.chn">Xem
                        toàn thị trường theo phiên</a>
                </td>
            </tr>
            ...
            <asp:Repeater runat="server" ID="rptData" OnItemDataBound="rptData_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr style="font-family: Arial; font-size: 10px; font-weight: normal; background-color: #f2f2f2"
                        ...
                        <td class="Item_Price" style="height: 30px;"><%#String.Format("{0:#,##0}", DataBinder.Eval(Container.DataItem, "NetVolume"))%>&nbsp;</td>
                        <td class="Item_Price" style="height: 30px;"><%#String.Format("{0:#,##0}", DataBinder.Eval(Container.DataItem, "NetValue"))%>&nbsp;</td>
                        ...
                        <td class="Item_Price" style="height: 30px;"><%#String.Format("{0:#,##0}", DataBinder.Eval(Container.DataItem, "BuyValue"))%>&nbsp;</td>
                        <td class="Item_Price" style="height: 30px;"><%#String.Format("{0:#,##0}", DataBinder.Eval(Container.DataItem, "SellVolume"))%>&nbsp;</td>
                        <td class="Item_Price" style="height: 30px;"><%#String.Format("{0:#,##0}", DataBinder.Eval(Container.DataItem, "SellValue"))%>&nbsp;</td>
                        <td class="Item_Price" style="height: 30px;"><asp:Literal runat="server" ID="ltrROOM_CONLAI"></asp:Literal>&nbsp;</td>
                        <td class="Item_Price" style="height: 30px;"><asp:Literal runat="server" ID="ltrSOHUU"></asp:Literal>&nbsp;</td>
                    </tr>
                </ItemTemplate>
