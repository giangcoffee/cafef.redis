...
namespace CafeF.Redis.BO
{
    ...
    public class UnicodeUtility
    {
        ...
        public const string keywords = "Album,Bác sỹ,Ban nhạc, Bảng xếp hạng,Báo điện tử,Bói toán,Ca khúc,Ca sỹ,Click,Điện ảnh,Đời sống,Fashion,For teen,Giải trí,Giới tính,Tình yêu,Giới trẻ,Kênh,Kênh 14,Làm đẹp,Lịch phim,Movie,Music,New,Hot,Nghệ sỹ,Nhạc,Nhạc Việt,Nhân vật,Phim,Phụ kiện,Sao,Scandal,Shock,Shopping,Sức khỏe,Teen,Teen idol,Teen life,Teen vietnam, Teen việt nam,Thần tượng,Thời trang,Tiêu điểm,Tin đồn,Tin tức,Tình yêu,Trailer,Trang phục,Trang tin,Tư vấn,US UK,Vpop (V-pop, V pop),	Vote,Xu hướng";
