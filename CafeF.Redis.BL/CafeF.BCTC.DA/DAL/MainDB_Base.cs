...
namespace CafeF.BCTC.DAL
{
	...
	public abstract class MainDB_Base : IDisposable
	{
        ...
        private StoredProceduresMaster _storedProceduresMaster;
        ...
        public StoredProceduresMaster StoredProceduresMaster
        {
            get
            {
                if (null == _storedProceduresMaster)
                    _storedProceduresMaster = new StoredProceduresMaster((MainDBMaster)this);
                return _storedProceduresMaster;
            }
        }
